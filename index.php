		...
		<div class="container">
			...
			<div class="row mt-5" id="aabody">
				...
				<div class="col s7 right-align">
					...
					<p>Чтобы дать подробную информацию о вашем теле мы подготовили материал, также здесь есть материал о пубертатном периоде</p>
				</div>
			</div>
			...
			<div class="row mt-5" id="table">
				<div class="col s7">
					<h1>Профилактика</h1>
					<p>В этой страничке есть информация о вредных привычках, пубертатном периоде и заболеваний во время этого периода</p>
				</div>
				<div class="col s5">
